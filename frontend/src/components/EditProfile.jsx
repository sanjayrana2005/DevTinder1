...
const EditProfile = ({ user }) => {
    ...
    return (
       <div className='flex flex-col sm:flex-row justify-center gap-4 h-screen sm:h-auto overflow-y-auto'>
            ...
            <div className='hidden sm:block'><ProfileUserCard user={{ firstName, lastName, age, gender, about, photoUrl,skills }} /></div>
        </div>
    );
}
